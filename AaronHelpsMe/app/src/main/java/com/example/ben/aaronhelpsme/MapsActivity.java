...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainHand= new Handler(this.getMainLooper());
...
//        }
    ...
    private BitmapDescriptor getDescriptor(String s){
        switch (s){
            ...
            case "tornado":
                ...
                Bitmap smallMarker3 = Bitmap.createScaledBitmap(b3,84, 84, false);
                return BitmapDescriptorFactory.
    ...
    public void addMarker(final Flag f){
        Runnable r = new Runnable(){
            ...
            public void run(){
                ...
                System.out.println("Added marker: " + disaster);
            }
    ...
    private void checkPoly(){
        ...
        if(fires.size() >= 3){
            ...
            if(x >= 3){
                ...
                currentPoly = mMap.addPolygon(ops.strokeColor(Color.BLACK).fillColor(Color
                        .argb(20, 200, 0, 0)));
    ...
    public void onMapReady(GoogleMap googleMap) {
       ...
       // longitude = currentLocation.getLongitude();
        ...
        this.mMap = googleMap;
        CodeStuff.getCon().startCheckTask();
       ...
       //         .snippet(comment));
        ...
        mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                Flag f = CodeStuff.getCon().getFlag(marker);
                if(f != null){
